...
from Other import (get_user_texts, Language, belarusian_language, ukrainian_language,
                   polish_language, russian_language, command_help, english_language, command_start)
...
async def change_search_city(message: types.Message):
    texts = get_user_texts(message.from_user.id, DB.session)
